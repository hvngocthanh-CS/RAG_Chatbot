...
Handles document parsing, preprocessing, chunking, table extraction,
...
from backend.services.document_parser import DocumentParser, Table
...
class DocumentIngestionService:
    ...
    async def process_document(
        ...
        """
        try:
            # Step 1: Parse document → ParsedDocument
